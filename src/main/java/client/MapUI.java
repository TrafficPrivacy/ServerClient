...
public final class MapUI implements PostProcess{
    ...
    private class MyLineLayer extends Polyline {
        ...
        @Override
        public synchronized void draw(BoundingBox boundingBox, byte zoomLevel, org.mapsforge.core.graphics.Canvas canvas, org.mapsforge.core.model.Point topLeftPoint) {
