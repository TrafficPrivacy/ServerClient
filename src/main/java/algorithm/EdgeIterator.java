...
public abstract class EdgeIterator implements Iterator<Boolean> {
  ...
  /**
   * Returns true is there are more edges. If returns true, then also iterate one step
   *
  ...
  /**
   * Get the cost of the current iterated edge. Note the cost could be time, or distance or both.
   *
